...
import { chatbotQna } from "@/lib/chatbot-qna";
...
const ERROR_REPLY = "Xin lỗi, mình đang gặp sự cố kết nối. Bạn thử lại sau ít phút nhé.";
...
export function ChatWidget() {
  ...
  async function sendMessage(text: string) {
    ...
    try {
      ...
      setMessages((prev) => [...prev, { from: "bot", text: reply || ERROR_REPLY }]);
    } catch {
      setMessages((prev) => [...prev, { from: "bot", text: ERROR_REPLY }]);
    } finally {
      setSending(false);
    }
  }
